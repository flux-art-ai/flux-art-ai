...
Flux Art 聚合 50+ 图像/视频模型([GPT Image 2](https://flux-art.cc/zh/models/gpt-image-2)、[Nano Banana 2](https://flux-art.cc/zh/models/nano-banana-2)、[Seedance 2.0](https://flux-art.cc/zh/models/seedance-2-0)、[Seedream 5.0 Pro](https://flux-art.cc/zh/models/seedream-5-0-pro) 等),提供图片生成与编辑双入口:局部重绘、多图融合、最多 14 张参考图、任意比例、最高 4K 零水印输出(付费档可商用),并配套 150+ 垂类 Agent、20K+ 提示词库与异步任务式 OpenAPI。
